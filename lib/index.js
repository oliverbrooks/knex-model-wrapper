...
Model.prototype.create = function createModel (options) {
  ...
  return lodash.assign({}, options, {
     ...
     */
    validate: function validateData (data, opts, action) {
      opts = opts || {};

      opts = this._setDefaultOpts(opts);

      return new Bluebird(function (resolve) {
        resolve(this._processData(data, opts, action));
      }.bind(this))
      .then(function (_data) {
        var form = validator(_data);
    ...
    insertMany: function insertDocuments (attrs, opts) {
      ...
      .then(function (_attrs) {
        _attrs = lodash.map(_attrs, function (item) {
          return this.validate(item, opts, "insert");
        }.bind(this));

        return Bluebird.all(_attrs);
      }.bind(this))
      .then(function (_attrs) {
        return db(this.tableName)
          .insert(_attrs)
     ...
     *
     */
    _processData: function (data, opts, action) {
