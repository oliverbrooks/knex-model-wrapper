...
var hannibal = new Hannibal({
  transforms: {
    /**
     * add a filter to hannibal so when an object is given instead of an RID it converts it to an RID
...
module.exports = function buildModel (options) {
  ...
  return lodash.assign({}, options, {
    ...
    select: function selectQuery () {
      var _db = db().from(this.tableName);
